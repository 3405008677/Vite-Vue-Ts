      ...
      <div class="login-content-main">
        ...
        <el-form ref="form" size="large" class="login-content-form" :model="formData" :rules="rules">
          ...
          <el-form-item prop="code" class="pt-10px pb-10px login-animation3">
            <el-col :span="15">
              <el-input v-model="formData.code" type="text" maxlength="4" placeholder="验证码" clearable autocomplete="off" @keyup.enter="onSignIn">
                <template #prefix>
                  <el-icon class="el-input__icon">
                    <position />
                  </el-icon>
  ...
  code: [
    ...
    { len: 4, message: 'Verification Length Should be 4', trigger: 'blur' },
    {
      validator: (rule: any, value: string, callback: Function) => {
        formData.value.code == identifyCode.value ? callback() : callback(new Error('Value Error Please Retype'))
      },
      trigger: 'blur',
    },
  ],
